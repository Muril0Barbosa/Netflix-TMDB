<template>
  <div>
    <v-container>
      <v-row>
        <v-col cols="12" sm="4">
          <v-hover v-sot="{ hover }" open-delay="200">
        ...
        <v-col cols="12" sm="8">
          ...
          <v-row>
            ...
            <v-col cols="12" sm="3">
              <span class="gray--text ml-n5">
                {{ movie.vote_average * 10 }}% | {{ movie.release_date }}
              </span>
            </v-col>
            <v-col cols="12" sm="7">
              <div class="subtitle-2 grey--text ml-n10">
                <span
          ...
          <v-dialog v-model="dialog" persistent max-width="800px">
            ...
            <v-card>
              ...
              <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="error" text @click="dialog = false">Sair</v-btn>
              </v-card-actions>
            </v-card>
          </v-dialog>
          <v-btn tile color="error" class="ml-2" >
            <v-icon left>mdi-movie-open-star</v-icon>Watchlist
          </v-btn>
        </v-col>
      </v-row>
